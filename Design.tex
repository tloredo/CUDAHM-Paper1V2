...
\enote{Provide some further details about the CUDAHM architecture, e.g., how random number generation is handled, and classes/structures available for passing information to/from the GPU.}
